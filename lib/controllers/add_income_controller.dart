...
class AddIncomeController extends GetxController {
  ...
  final incomeDescription = TextEditingController();
  final incomeAmount = TextEditingController();
  final incomeDate = TextEditingController();
  final incomeCategory = TextEditingController();
  ...
  void onClose() {
    ...
    incomeDescription.dispose();
    incomeAmount.dispose();
    incomeDate.dispose();
    incomeCategory.dispose();
